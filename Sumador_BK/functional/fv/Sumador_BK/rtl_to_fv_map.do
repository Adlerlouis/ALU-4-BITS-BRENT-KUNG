...
# Generated on: Thu Dec 05 19:11:01 CST 2024 (Fri Dec 06 01:11:01 UTC 2024)
...
set logfile fv/Sumador_BK/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/Sumador_BK -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/al-labse15/Half_Adder/HalfAdder/functional/verilog.v
add_search_path . -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/al-labse15/SumadorBrentKung/Black_Cell_Impar/functional/verilog.v
add_search_path . -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/al-labse15/SumadorBrentKung/Buffer_Impar/functional/verilog.v
add_search_path . -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/al-labse15/SumadorBrentKung/Buffer_Par/functional/verilog.v
add_search_path . -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/al-labse15/SumadorBrentKung/Estructura_Final/functional/verilog.v
add_search_path . -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/al-labse15/SumadorBrentKung/Gray_Cell_Impar/functional/verilog.v
add_search_path . -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/al-labse15/SumadorBrentKung/Gray_Cell_Par/functional/verilog.v
add_search_path . -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/al-labse15/SumadorBrentKung/Sumador_BK/functional/verilog.v
elaborate_design -golden -root {Sumador_BK} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/Sumador_BK/fv_map.v.gz
elaborate_design -revised -root {Sumador_BK}
...
set_system_mode lec
write_compared_points noneq.compared_points.Sumador_BK.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.Sumador_BK.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.Sumador_BK.rtl.fv_map.rpt
