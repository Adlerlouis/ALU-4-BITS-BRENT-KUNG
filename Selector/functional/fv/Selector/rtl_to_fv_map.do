...
# Generated on: Fri Dec 06 19:47:44 CST 2024 (Sat Dec 07 01:47:44 UTC 2024)
...
set logfile fv/Selector/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/Selector -revised fv_map
...
read_library -liberty -both \
    /home/al-labse15/SumadorBrentKung/Selector/functional/libCompleta.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/al-labse15/SumadorBrentKung/Selector/functional/verilog.v
elaborate_design -golden -root {Selector} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/Selector/fv_map.v.gz
elaborate_design -revised -root {Selector}
...
add_black_box HalfAdder Sumador_BK -golden
...
set_system_mode lec
write_compared_points noneq.compared_points.Selector.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.Selector.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.Selector.rtl.fv_map.rpt
